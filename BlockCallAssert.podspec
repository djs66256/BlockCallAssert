#
#  Be sure to run `pod spec lint BlockCallAssert.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/djs66256/BlockCallAssert"
  ...
  s.source       = { :git => "https://github.com/djs66256/BlockCallAssert.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Sources", "Sources/**/*.{h,m,s}"
